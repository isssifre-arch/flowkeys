...
**简体中文** ｜ [English](README.md) ｜ [한국어](README.ko.md) ｜ [日本語](README.ja.md) ｜ [Русский](README.ru.md) ｜ [Español](README.es.md)

用 MIDI 键盘跟弹学琴的桌面应用：3D 琴键可视化 + 五线谱 / 简谱 / 钢琴块 + 内置 SoundFont 音源（无需宿主）。界面支持简体中文 / English / 한국어 / 日本語 / Русский / Español。
...
- 界面多语言：简体中文 / English / 한국어 / 日本語 / Русский / Español（设置 → 通用 → 语言；首次启动自动跟随系统语言）
- 背景主题四套；诊断信息一键复制
